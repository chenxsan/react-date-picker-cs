...
exports['default'] = _react2['default'].createClass({
    ...
    render: function render() {
        return _react2['default'].createElement(
            ...
            _react2['default'].createElement(_weekDays2['default'], { locale: this.props.locale, highlight: new Date(this.props.date).getFullYear() === this.state.year && new Date(this.props.date).getMonth() + 1 === this.state.month, year: this.state.year, month: Number(this.state.month), day: Number(this.state.day), selectDay: this.selectDay }),
            _react2['default'].createElement(
                'div',
